                ...
                <div class="box-body">
                    <table id="fileTable1" class="display responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="bankDetailsModal{{ $index }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>AC Holder Name:</strong> {{ $BalanceRequest->app_user_name ??
                                                'N/A' }}</p>
                                            <p><strong>Bank AC No.:</strong> {{ $BalanceRequest->bank_account_no ??
                                                'N/A' }}</p>
                                            ...
                                            <center>
                                                <img src="{{ asset($BalanceRequest->upi_qr_code) }}" width="200"
                                                    alt="UPI QR Code">
                                            </center>
                                            @else
                                            <p>N/A</p>
